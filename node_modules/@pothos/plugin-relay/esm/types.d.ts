...
export type ArrayConnectionEdgesShape<Types extends SchemaTypes, T, NodeNullable extends boolean, EdgesNullable extends FieldNullability<[
    unknown
...
export type ConnectionEdgesShape<Types extends SchemaTypes, T, NodeNullable extends boolean, EdgesNullable extends FieldNullability<[
    unknown
]>> = ArrayConnectionEdgesShape<Types, T, NodeNullable, EdgesNullable> extends infer Edges ? Awaited<ListResolveValue<Edges, Edges extends readonly (infer Item)[] ? Item : never, unknown>> : never;
...
export interface ArrayConnectionResultShape<Types extends SchemaTypes, T, EdgesNullable extends FieldNullability<[
    unknown
]> = Types["DefaultEdgesNullability"], NodeNullable extends boolean = Types["DefaultNodeNullability"]> {
