import SchemaBuilder, { BaseTypeRef, completeValue, createContextCache, getTypeBrand, InputObjectRef, isThenable, ObjectRef, PothosValidationError, verifyRef } from '@pothos/core';
    ...
    if (nodeQueryOptions !== false) {
        ...
        this.queryField("node", (t) => {
            ...
            return t.field({
                ...
                resolve: resolveNodeFn ? (root, args, context, info) => resolveNodeFn(root, args, context, info, (_ids) => completeValue(resolveNodes(this, context, info, [
                    args.id
                ]), (nodes) => nodes[0])) : (_root, args, context, info) => completeValue(resolveNodes(this, context, info, [
                    args.id
                ]), (nodes) => nodes[0])
            });
        });
    ...
    if (nodesQueryOptions !== false) {
        ...
        this.queryField("nodes", (t) => {
            ...
            return t.field({
                ...
                resolve: resolveNodesFn ? (root, args, context, info) => resolveNodesFn(root, args, context, info, (_ids) => resolveNodes(this, context, info, args.ids)) : (_root, args, context, info) => resolveNodes(this, context, info, args.ids)
            });
        });
    }
    return ref;
