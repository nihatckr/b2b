    ...
    export namespace PothosSchemaTypes {
        ...
        interface SchemaBuilder<Types extends SchemaTypes> {
            ...
            connectionObject: <Type extends OutputType<Types>, ResolveReturnShape, EdgeNullability extends FieldNullability<[
                unknown
            ]> = Types["DefaultEdgesNullability"], NodeNullability extends boolean = Types["DefaultNodeNullability"], const ConnectionInterfaces extends InterfaceParam<Types>[] = [
            ...
            edgeObject: <Type extends OutputType<Types>, ResolveReturnShape, NodeNullability extends boolean = Types["DefaultNodeNullability"], const Interfaces extends InterfaceParam<Types>[] = [
        ...
        ]> extends ObjectTypeWithInterfaceOptions<Types, GetAwaitedListItem<Merge<ConnectionShapeFromResolve<Types, Type, false, false, NodeNullability, Resolved>["edges"]>>, Interfaces> {
            name?: string;
