import { completeValue, ObjectFieldBuilder } from '@pothos/core';
export function addNodeProperties(name, builder, ref, param, options) {
    ref.addInterfaces([
    ...
    ref.addFields(() => {
        ...
        return {
            [(_builder_options_relay_idFieldName = (_builder_options_relay = builder.options.relay) === null || _builder_options_relay === void 0 ? void 0 : _builder_options_relay.idFieldName) !== null && _builder_options_relay_idFieldName !== void 0 ? _builder_options_relay_idFieldName : "id"]: new ObjectFieldBuilder(builder).globalID({
                nullable: false,
                ...
                ...options.id,
                args: {},
                resolve: (parent, args, context, info) => completeValue(options.id.resolve(parent, args, context, info), (globalId) => ({
                    type: name,
                    id: globalId
                }))
            })
