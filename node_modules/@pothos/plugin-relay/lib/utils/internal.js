...
_export(exports, {
    get internalDecodeGlobalID () {
        return internalDecodeGlobalID;
    },
    get internalEncodeGlobalID () {
...
function internalDecodeGlobalID(builder, globalID, ctx, info, parseIdsForTypes) {
    var _builder_options_relay;
    const decoded = ((_builder_options_relay = builder.options.relay) === null || _builder_options_relay === void 0 ? void 0 : _builder_options_relay.decodeGlobalID) ? builder.options.relay.decodeGlobalID(globalID, ctx) : (0, _globalids.decodeGlobalID)(globalID);
