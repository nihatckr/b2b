...
Object.defineProperty(exports, "InputValidationError", {
    enumerable: true,
    get: function() {
...
class InputValidationError extends _core.PothosValidationError {
    constructor({ issues }){
        super(`Validation error: ${issues.map((issue)=>{
            var _issue_path;
