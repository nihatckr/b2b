...
export function SingleFileUpload({ category = 'temp', onSuccess }: SingleFileUploadProps) {
  const [file, setFile] = useState<File | null>(null);
  const [description, setDescription] = useState('');
  const [result, executeMutation] = useMutation(SINGLE_UPLOAD_MUTATION);
...
export function MultipleFileUpload({
  ...
  const [description, setDescription] = useState('');
  const [result, executeMutation] = useMutation(MULTIPLE_UPLOAD_MUTATION);
