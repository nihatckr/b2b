...
export default interface PrismaTypes {
    ...
    LibraryItem: {
        ...
        Create: {};
        Update: {};
        RelationName: "company" | "standardItem" | "companyItems" | "certifications" | "certifiedItems" | "collections" | "createdBy";
        ListRelations: "companyItems" | "certifications" | "certifiedItems" | "collections";
        Relations: {
            company: {
                Shape: Company | null;
                Name: "Company";
